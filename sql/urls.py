...
urlpatterns = [
    ...
    path('sqldataout/', views.sqldataout),
    path('submitsql/', views.submit_sql),
    path('submitSelectsql/', views.submit_select_sql),
    path('editsql/', views.submit_sql),
    path('editSelectsql/', views.submit_select_sql),
    ...
    path('autoreviewSelect/', sql_workflow.submit_select),
    path('passed/', sql_workflow.passed),
    path('execute/', sql_workflow.execute),
    path('executeSelect/', sql_workflow.execute_select),
    ...
    path('sqloutput/', views.sqloutput),
    ...
    path('simpleSelectcheck/', sql_workflow.select_check),
